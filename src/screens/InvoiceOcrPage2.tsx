...
export function parseInvoiceText(fullText: string): InvoiceData {
    ...
    // --- STRATEJİ 1: "Etiket : Değer" Aynı Satırda Formatı ---
    ...
    // --- STRATEJİ 2: "Başlıklar-Sonra-Değerler" Blok Formatı ---
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
            <div className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1"><FieldLabel icon={<Home className="w-3.5 h-3.5" />}>Adres</FieldLabel><textarea value={data.address} onChange={(e) => setData({ ...data, address: e.g. value })} rows={3} className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400" placeholder="Sokak, Cadde, No, İlçe, İl" /></div>
