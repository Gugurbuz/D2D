...
export default function InvoiceOcrPage() {
  ...
  const [loadingMessage, setLoadingMessage] = useState("OCR Motoru Yükleniyor...");
  ...
  async function runOcrAndParse(file: File) {
    ...
    try {
      ...
      await tesseractWorker.current.setParameters({ tessedit_pageseg_mode: PSM.AUTO });
            ...
            <div className="p-4 md:p-6">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-xl overflow-hidden border">
                  ...
                  <div className="aspect-video bg-white flex items-center justify-center">{processedImagePreview ? <img src={processedImagePreview} alt="processed preview" className="max-h-full object-contain" /> : <div className="text-gray-400 text-sm">OCR için hazırlanan görüntü</div>}</div>
                </div>
              </div>
