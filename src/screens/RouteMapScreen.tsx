...
/* ============ LOGO ============ */
/** .env’de VITE_REP_LOGO_URL tanımlıysa onu kullanır; yoksa sarı-lacivert SVG fallback. */
const REP_LOGO_URL =
  import.meta.env.VITE_REP_LOGO_URL ||
  ...
  encodeURIComponent(
    `<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'>
      ...
      <circle cx='20' cy='20' r='18' fill='${BRAND_NAVY}' stroke='white' stroke-width='3' filter='url(#shadow)'/>
      <text x='20' y='24' text-anchor='middle' font-size='16' font-weight='700' fill='${BRAND_YELLOW}' font-family='Arial, Helvetica, sans-serif'>E</text>
    </svg>`
  );
...
function createRepIcon(logoUrl: string) {
  // Görsel + pin hissi için küçük bir “badge” kapsayıcı
  return L.divIcon({
...
// Müşteri sıra ikonları (mevcut renk düzeni korunuyor)
    ...
    <div className="relative w-full h-full">
      ...
      <div className="relative h-[560px] w-full rounded-2xl overflow-hidden shadow-xl">
        ...
        >
          ...
          {/* Satışçı marker: Enerjisa logosu */}
          ...
          {/* Rota: Enerjisa Sarısı (arkaya beyaz gölge ile okunaklılık arttırıldı) */}
