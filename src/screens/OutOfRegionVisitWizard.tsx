...
export default function OutOfRegionVisitWizard({
  ...
  // 0. adım verileri (InvoiceOcrPage set ediyor)
  ...
  // ---- UI ----
  return (
    <div className="min-h-screen pb-28"> {/* pb-28: sticky bar için boşluk */}
      {/* Stepper */}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-lg border p-3">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>
                    <b>Müşteri Tipi:</b> {summary.customerType}
                  </li>
                  <li>
                    <b>Ad/Unvan:</b> {summary.customerName || "-"}
                  </li>
                  <li>
                    <b>Adres:</b> {summary.customerAddress || "-"}
                  </li>
                </ul>
              </div>
              <div className="rounded-lg border p-3">
      ...
      {/* === STICKY ACTION BAR === */}
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/85 backdrop-blur border-t border-gray-200">
