              ...
              <div className="mt-4 space-y-4">
                ...
                {hasAnyAIData && (
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-xl border bg-gray-50 hover:bg-gray-100 text-sm font-medium text-gray-700 mt-4"
