...
import { colorTones, BRAND_COLORS } from '../../../styles/theme';
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            ...
            <div className="text-xs text-gray-500">
              Tesisat No: {customer.installationNumber ?? '-'}
            </div>
          </div>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs bg-[${colorTones.navy[50]}] text-[${BRAND_COLORS.navy}] ring-1 ring-[${colorTones.navy[200]}]`}>
              {typeLabel}
            </span>
